/* ==================== ADS1115 ADC DRIVER ==================== */
// Adafruit ADS1115 - 4-Kanal 16-Bit ADC über I2C
// Verwendet für: Gaspedal, Stromsensor, Lenkwinkel Kalibrierung
...
public:
  ...
  // Lese Kanal mit Mittelwertbildung
  ...
  // Stromsensor Kanal (ADS1115 Eingang 3)
